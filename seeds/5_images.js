...
exports.seed = function(knex) {
  return knex('images').del()
    .then(() => knex('images').insert([
      {
        image_id: 1,
        image_public_id: 'decorative/1/inqblewellycdalixs6g',
        image_main: true,
        product_id: 1,
      ...
      {
        image_id: 2,
        image_public_id: 'decorative/2/jgqlsddcyrtfctsscmxs',
        image_main: true,
        product_id: 2,
      ...
      {
        image_id: 3,
        image_public_id: 'jewelry/3/ghkfwhp1jn34sqdrnk9y',
        image_main: true,
        product_id: 3,
      ...
      {
        image_id: 4,
        image_public_id: 'garden/4/b5glogxrv30qevvkadr3',
        image_main: true,
        product_id: 4,
      ...
      {
        image_id: 5,
        image_public_id: 'garden/5/vjtp99vst7alp3rigoqm',
        image_main: true,
        product_id: 5,
      ...
      {
        image_id: 6,
        image_public_id: 'jewelry/6/gzzwbjolt89kuwydw3yv',
        image_main: true,
        product_id: 6,
      ...
      {
        image_id: 7,
        image_public_id: 'houseware/7/sqbxjea1wxsjqc3ipga5',
        image_main: true,
        product_id: 7,
      ...
      {
        image_id: 8,
        image_public_id: 'houseware/8/f2kype9guf2c8buxdjo7',
        image_main: true,
        product_id: 8,
      ...
      {
        image_id: 9,
        image_public_id: 'houseware/9/a3yzak0moh9jvt1l7opl',
        image_main: true,
        product_id: 9,
